...
V3_WEIGHTS = os.path.join(PROJECT_ROOT, "runs/fold_0_v3_dn/camplus_finetuned_best.pt")
...
def main():
    ...
    with open(os.path.join(PROJECT_ROOT, "runs", "fold0_pipeline_compare_v3dn.json"), "w", encoding="utf-8") as f:
        json.dump(out, f, ensure_ascii=False, indent=2)
    print("\n已保存: runs/fold0_pipeline_compare_v3dn.json")
